            ...
            <div className="group relative rounded-2xl bg-surface/95 border border-border p-4 sm:p-5 shadow-sm transition-all duration-200 hover:shadow-md">
                ...
                <div className="mt-3 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground focus:outline-none"
                    >
                        <Plus size={18} />
                    </button>
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            isEmpty || isLoading
                                ? "bg-indigo/40 cursor-not-allowed"
                                : "bg-gradient-primary text-primary-foreground hover:opacity-95 hover:scale-105 active:scale-95"
                        )}
                    >
                        <ArrowUp
                            size={16}
