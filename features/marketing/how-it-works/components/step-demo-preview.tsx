...
function renderPreviewContent(stepId: StepId) {
    switch (stepId) {
        case 0:
            return (
                <div className="h-full w-full bg-subtle border-b border-border p-6 font-mono">
                    <div className="flex flex-col gap-4">
                        <div className="flex items-start gap-3">
                            <div className="h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center">
                                <div className="h-4 w-4 rounded-full bg-primary" />
                            </div>
                            <div className="max-w-[80%] rounded-2xl rounded-tl-none bg-surface border border-border p-4 text-sm text-text-primary leading-relaxed shadow-md">
                                I run a yoga studio. I offer classes, private sessions, and sell wellness products online.
                            </div>
                        </div>
                        <div className="flex items-center gap-3 self-end">
                            <div className="text-xs text-text-muted">AI thinking...</div>
        ...
        case 1:
            return (
                <div className="h-full w-full grid grid-cols-2">
                    ...
                    <div className="bg-subtle border-l border-border p-6 flex flex-col gap-2 overflow-hidden">
                        <div className="text-[10px] font-mono text-success/80">
        ...
        case 2:
            return (
                <div className="h-full w-full flex flex-col overflow-hidden">
                    ...
                    <div className="h-2/3 w-full bg-surface border-b border-border p-4 relative">
                        ...
                        <div className="absolute top-2 right-2 flex items-center gap-1.5 px-2 py-1 bg-success-subtle border border-success/20 rounded-full">
                            <div className="h-1.5 w-1.5 rounded-full bg-success animate-pulse" />
                            <span className="text-[10px] font-bold text-success uppercase tracking-tighter">yogastudio.com is live</span>
                        </div>
                    </div>
                    {/* Admin Panel Preview */}
