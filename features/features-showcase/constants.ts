...
export const FEATURES: Feature[] = [
    {
        ...
        description: 'Most tools copy-paste generic content. Info Lab deeply learns your industry, brand identity, and customer psychology — then generates a strategy and presence that actually converts visitors into lifelong customers.',
        size: 'large',
        visualType: 'chat',
    },
    {
