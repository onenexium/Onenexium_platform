...
export function FeatureHighlightLarge({
    ...
    return (
        <motion.div
            variants={variants}
            className={cn(
                'group relative flex flex-col overflow-hidden rounded-2xl border border-border bg-card p-8 transition-all duration-200 hover:border-primary/40 hover:bg-card/80 hover:shadow-md lg:col-span-2 md:min-h-[256px]'
            )}
        >
