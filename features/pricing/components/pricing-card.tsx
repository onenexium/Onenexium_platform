...
export function PricingCard({ plan, interval }: PricingCardProps) {
    ...
    return (
        <div className={cn(
            "relative p-8 rounded-2xl border bg-card flex flex-col h-full transition-all duration-300",
            plan.recommended
                ? "border-primary shadow-lg shadow-primary/10 bg-gradient-to-b from-primary/5 to-transparent z-10 scale-105"
